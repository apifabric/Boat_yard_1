...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.BoatService, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.StorageSlot, method_decorators= method_decorators)
