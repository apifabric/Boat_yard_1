...
resourcename="boatyard1"  # lower case, only
resourcegroup="boatyard1_rg"
...
# git clone https://github.com/apilogicserver/boatyard1.git
# cd boatyard1
...
az group create --name boatyard1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group boatyard1_rg --sku S1 --is-linux
az container create --resource-group boatyard1_rg --name boatyard1 --image apilogicserver/boatyard1:latest --dns-name-label boatyard1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//boatyard1.westus.azurecontainer.io:5656'
